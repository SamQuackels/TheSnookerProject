...
namespace Test_Connection
{
    class SQLFunctions
    {
        ...
        public void AddItems(string connectionString, string commandString, ListBox lb)
        {
            if (tryConnection(connectionString))
            {
                lb.Items.Clear();
        ...
        public void CreateNewMatch(string connectString, string groupID1, string groupID2, string team1user1ID, string team1user2ID, string team1user3ID, string team2user1ID, string team2user2ID, string team2user3ID)
        {
